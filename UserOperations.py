...
class UserOperations:
    ...
    def load_food_items(self):
            with open(r'D:\DS140823\Final_Project\FoodItems.json', 'r') as file:
                self.data= json.load(file)
    def write_food_items(self,data):
        with open(r'D:\DS140823\Final_Project\orderHistory.json','w') as addfile:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'D:\DS140823\Final_Project\orderHistory.json','r') as file:
    ...
    def updateProfile(self):
        ...
        with open(r'D:\DS140823\Final_Project\details.json', 'r') as file:
        ...
        for credit in credentials:
            if credit['name']==self.name:
                ...
                with open(r'D:\DS140823\Final_Project\details.json','w') as w:
